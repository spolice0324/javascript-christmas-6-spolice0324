...
describe('Discount 클래스 로직 테스트', () => {
  ...
  describe('평일 할인 메소드 테스트', () => {
    test('평일(일~토)이라면 주문 내역 중 디저트 메뉴를 할인하는 금액이 올바르게 계산되어야 한다. - 디저트 메뉴가 0개일 때', () => {
    ...
    test('평일(일~토)이라면 주문 내역 중 디저트 메뉴를 할인하는 금액이 올바르게 계산되어야 한다. - 디저트 메뉴가 1개일 때', () => {
      const date = DATE.EVENT_START + 3;
    ...
    test('평일(일~토)이라면 주문 내역 중 디저트 메뉴를 할인하는 금액이 올바르게 계산되어야 한다. - 디저트 메뉴가 여러개일 때', () => {
      const date = DATE.EVENT_START + 3;
